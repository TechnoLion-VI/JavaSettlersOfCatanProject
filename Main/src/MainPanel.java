...
//                        JCheckBox c1 = new JCheckBox(GameState.currentPlayer.getResourceCards().get(i).getType() + "");
//                        c1.setBackground(new Color(255, 220, 100));
//                        c1.setBounds(x, y, 200, 20);
//                        p.add(c1);
//                        if (y >= 400) {
//                            x += 80;
//                            y = 20;
...
//                    }
                                            ...
                                            JButton done = new JButton("Done");
                                                ...
                                                public void actionPerformed(java.awt.event.ActionEvent evt) {
                                                    ...
                                                    JLabel tradeMessageTwo = new JLabel("<html>Please type in how many of each resource<br>you wish to trade for.");
